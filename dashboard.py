...
class SystemStats:
    ...
    def __init__(self, stats_cache_file):
        self.stats_df = self.load_stats(stats_cache_file)
    ...
    def unpack_alerts(self):
        ...
        for time, alerts in zip(self.stats_df['Time'], self.stats_df['Alerts']):
    ...
    #     filtered_stats_df = display_df.loc[mask]

    #     # Display the DataFrame
    #     st.subheader(f'Ticker Scans ({len(filtered_stats_df)})')
    #     st.dataframe(
    #        filtered_stats_df,
